...
export default function FormJob() {
  return(
    <div className="pt-12 px-8 lg:text-sm 2xl:text-base">
      ...
      <div className="flex gap-12 px-10 2xl:px-5 pt-5">
        <div className="w-1/3 flex flex-col gap-4 2xl:gap-12">
        ...
        <div className="w-1/3 flex flex-col gap-4 2xl:gap-12">
          <Input className="[&>label]:mb-1" label="Quantidade:" placeholder="Digite a quantidade..." />

          <Input className="[&>label]:mb-1" label="Responsavel:" placeholder="Digite o responsavel..." />
